...
public class WatchlistRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder> {
    ...
    public WatchlistRecyclerViewAdapter(Activity activity, List<Product> products) {
